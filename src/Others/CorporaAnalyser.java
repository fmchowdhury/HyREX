	...
	public static void main ( String[] args ) throws Exception {
		...
		for ( int i=0; i<pre.length; i++ ) {
			...
			System.out.println("Avg No Of Words Bet Entities In Sen = " 
					+ DataStrucUtility.roundNDecimals(new CorporaAnalyser().getAvgNoOfWordsBetEntitiesInSen(listOfSentences, true), 4));
			...
			System.out.println("Avg No Of Words In Ent Names = " 
					+ DataStrucUtility.roundNDecimals(avgNoOfWordsInEntNames, 4));
			...
			System.out.println("Avg No Of Words Of Sen = " 
					+ DataStrucUtility.roundNDecimals(avgNoOfWordsOfSen, 4));
			System.out.println("Ratio Of Subtoken Entities = " 
					+ DataStrucUtility.roundNDecimals(new CorporaAnalyser().getRatioOfDiscontinuousEntities
			...
			System.out.println("Avg No Of Entities Per Sen = " 
					+ DataStrucUtility.roundNDecimals(avgNoOfEntitiesPerSen, 4));
			
			System.out.println("Avg No Of words without Entities Per Sen = " 
					+ DataStrucUtility.roundNDecimals( avgNoOfWordsOfSen - avgNoOfEntitiesPerSen*avgNoOfWordsInEntNames, 4));
