...
public class TextUtility {
	 ...
	 * @return
	 */
	public static boolean isPronoun( String word, String pos ) {
	 ...
	 * @return
	 */
	public static String normalizeDangelingCaharactersInRegExp_x( String strRegEx ){
